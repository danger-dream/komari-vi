...
const PublicInfoContext = React.createContext<PublicInfoContextType | undefined>(undefined)
...
export const PublicInfoProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	return <PublicInfoContext.Provider value={{ publicInfo, isLoading, error, refresh }}>{children}</PublicInfoContext.Provider>
}
