...
const PingTaskContext = React.createContext<PingTaskContextType | undefined>(undefined)

export const PingTaskProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	return <PingTaskContext.Provider value={{ pingTasks, isLoading, error, refresh }}>{children}</PingTaskContext.Provider>
}
