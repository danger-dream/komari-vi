...
const LoadAlertContext = React.createContext<LoadAlertContextType | undefined>(undefined)

export const LoadAlertProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	return <LoadAlertContext.Provider value={{ loadAlerts, isLoading, error, refresh }}>{children}</LoadAlertContext.Provider>
}
