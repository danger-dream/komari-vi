...
export async function getSettings(): Promise<SettingsResponse> {
	...
	settingsPromise = (async () => {
		try {
			...
			settingsCache = settings as SettingsResponse
...
export async function updateSettingsWithToast(settings: Partial<SettingsResponse>, t: (key: string) => string): Promise<void> {
	try {
...
export function useSettings() {
	...
	const updateSetting = async <K extends keyof SettingsResponse>(key: K, value: SettingsResponse[K]) => {
		try {
