...
const TerminalArea: React.FC<TerminalAreaProps> = ({ terminalRef, toggleClipboard, width, isOpen }) => (
	<div className="relative flex justify-center bg-black md:bg-accent-3 flex-col h-full min-w-128" style={{ width }}>
...
const Divider: React.FC<{
	...
	<div className="h-full bg-accent-2 cursor-col-resize hover:bg-accent-4" style={{ width: 8 }} onMouseDown={onMouseDown} onTouchStart={onMouseDown} />
)
			...
			<Theme appearance="dark">
				...
				<div className="absolute inset-x-0 top-4 flex justify-center items-center z-30">
					<motion.div
						...
						hidden={!callout}>
						<Callout.Root color="red" size="2" className="bg-red-50 backdrop-blur-sm border-2 border-red-800 rounded-lg">
							<Callout.Icon>
