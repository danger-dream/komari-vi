...
export default function InstancePage() {
	...
	return (
		<Flex className="items-center" direction={'column'} gap="2">
			...
			<SegmentedControl.Root radius="full" value={chartView} onValueChange={value => setChartView(value as 'load' | 'ping')}>
			...
			{/* Recharts */}
			{chartView === 'load' ? <LoadChart data={liveDataToRecords(uuid ?? '', recent)} /> : <PingChart uuid={uuid ?? ''} />}
