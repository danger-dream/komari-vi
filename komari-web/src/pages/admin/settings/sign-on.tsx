import { SettingCardLabel, SettingCardSelect, SettingCardShortTextInput, SettingCardSwitch } from '@/components/admin/SettingCard'
		...
		fetch('/api/admin/settings/oidc')
			...
			.then(data => {
				if (data.status === 'success' && data.data) {
					...
					const initialProvider = settings.o_auth_provider && providers.includes(settings.o_auth_provider) ? settings.o_auth_provider : ''
