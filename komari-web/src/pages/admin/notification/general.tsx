		...
		<>
			...
			<SettingCardSwitch
				...
				onChange={async checked => {
					await updateSettingsWithToast({ expire_notification_enabled: checked }, t)
				}}
			/>
			<SettingCardShortTextInput
				...
				OnSave={async value => {
					...
					await updateSettingsWithToast({ expire_notification_lead_days: numValue }, t)
				}}
			/>
			...
			<SettingCardSwitch
				...
				onChange={async checked => {
					await updateSettingsWithToast({ login_notification: checked }, t)
				}}
			/>
			...
			<SettingCardShortTextInput
				...
				type="number"
				OnSave={async value => {
					await updateSettingsWithToast({ traffic_limit_percentage: Number(value) }, t)
				}}
			/>
		</>
	)
