		...
		if (this.state.hasError) {
			return (
				<div className="flex flex-col items-center justify-center min-h-[300px] p-8 bg-gradient-to-br from-rose-50 to-red-50 border border-red-200 rounded-md shadow-md max-w-3xl mx-auto">
					...
					{/* Title */}
					<h2 className="text-3xl font-semibold text-red-700 mb-3 tracking-tight">Something Went Wrong</h2>

					{/* Error Message */}
					<p className="text-red-600 text-lg mb-6 font-medium text-center">{this.state.error?.message || 'An unexpected error occurred.'}</p>
